...
fit_output = pd.read_csv('output/Bcell/Fits/Fit_Output_2025-12-03T18_19_00.csv')
metadata = pd.read_csv('data/Zhang_CancerCell_2025_sub/Bcell/metadata.csv')
